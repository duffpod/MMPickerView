...
@property (copy) void (^onDismissCancellation)();
...
+(void)showPickerViewInView:(UIView *)view
    ...
    [[self sharedView] setPickerHidden:NO completion:nil cancellation:nil];
...
+(void)showPickerViewInView:(UIView *)view
    ...
    [self sharedView].objectToStringConverter = converter;
    [self sharedView].onDismissCompletion = completion;
    [self sharedView].onDismissCancellation = cancel;
    [[self sharedView] initializePickerViewInView:view
                                        withArray:objects
                                      withOptions:options];
    [[self sharedView] setPickerHidden:NO completion:nil cancellation:nil];
...
+(void)dismissWithCompletion:(void (^)(NSString *))completion cancellation:(void(^)())cancellation{
    [[self sharedView] setPickerHidden:YES completion:completion cancellation:cancellation];
}

-(void)dismiss{
    [MMPickerView dismissWithCompletion:self.onDismissCompletion cancellation:nil];
}

-(void)dismissCancel{
    [MMPickerView dismissWithCompletion:nil cancellation:self.onDismissCancellation];
}
                     ...
                     animations:^{
                         ...
                         if(completed && hidden){
                             ...
                             if(completion) {
                                 ...
                                 completion([self selectedObject]);
...
-(void)initializePickerViewInView: (UIView *)view
    ...
    _pickerViewCancelBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(dismissCancel)];
